...
import { LayoutDashboard, Search, BookOpen, User, ArrowLeft, Menu, X } from "lucide-react";
    ...
    <>
      ...
      >
        <div className="px-5 h-16 flex items-center justify-between border-b border-gray-100">
          <Link href="/dashboard_calon" className="flex items-center gap-2 font-bold text-xl text-blue-600">
