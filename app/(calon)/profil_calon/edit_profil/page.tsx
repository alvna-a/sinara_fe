    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        <input
          ...
          placeholder={placeholder}
          className="px-3 sm:px-4 py-2 pr-10 border border-gray-200 rounded-xl text-xs sm:text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all w-full bg-white"
        />
        <button
          type="button"
          onClick={onToggle}
