...
import { Bot, Calendar, ChevronRight, Search } from "lucide-react";
...
export default function RiwayatRekomendasiPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EEF2FF]">
      <SidebarCalon />
      <DashboardNavbar pageTitle="Riwayat Rekomendasi" userName="" userRole="calon" />
          ...
          {activeTab === "wishlist" && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
                Belum ada divisi yang kamu simpan ke wishlist. Lihat hasil rekomendasi dan klik
                "Simpan ke Wishlist" untuk menyimpannya di sini.
              </p>
            </div>
          )}
